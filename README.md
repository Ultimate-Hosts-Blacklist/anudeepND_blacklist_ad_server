# About anudeepND_blacklist_ad_server

[![Build Status](https://travis-ci.org/Ultimate-Hosts-Blacklist/anudeepND_blacklist_ad_server.svg?branch=master)](https://travis-ci.org/Ultimate-Hosts-Blacklist/anudeepND_blacklist_ad_server)

```
# Host file to block ads, tracking and more! Updated daily
# 
# Project home page: https://github.com/anudeepND/blacklist
